...
METER_SENSOR_TYPES = {
    ...
    "EXPORT_VARH_Q3": ["Export varh Q3", "exportvarhq3", ENERGY_VOLT_AMPERE_REACTIVE_HOUR, None, None],
    "EXPORT_VARH_Q3_A": ["Export varh Q3 A", "exportvarhq3a", ENERGY_VOLT_AMPERE_REACTIVE_HOUR, None, None],
    "EXPORT_VARH_Q3_B": ["Export varh Q3 B", "exportvarhq3b", ENERGY_VOLT_AMPERE_REACTIVE_HOUR, None, None],
    "EXPORT_VARH_Q3_C": ["Export varh Q3 C", "exportvarhq3c", ENERGY_VOLT_AMPERE_REACTIVE_HOUR, None, None],
    "EXPORT_VARH_Q4": ["Export varh Q4", "exportvarhq4", ENERGY_VOLT_AMPERE_REACTIVE_HOUR, None, None],
    "EXPORT_VARH_Q4_A": ["Export varh Q4 A", "exportvarhq4a", ENERGY_VOLT_AMPERE_REACTIVE_HOUR, None, None],
    "EXPORT_VARH_Q4_B": ["Export varh Q4 B", "exportvarhq4b", ENERGY_VOLT_AMPERE_REACTIVE_HOUR, None, None],
    "EXPORT_VARH_Q4_C": ["Export varh Q4 C", "exportvarhq4c", ENERGY_VOLT_AMPERE_REACTIVE_HOUR, None, None],
