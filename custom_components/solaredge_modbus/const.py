...
METER_SENSOR_TYPES = {
    ...
    "EXPORTED_KWH_A": ["EXPORTED A KWH", "exporteda", ENERGY_KILO_WATT_HOUR, None, None],
    "EXPORTED_KWH_B": ["EXPORTED B KWH", "exportedb", ENERGY_KILO_WATT_HOUR, None, None],
    "EXPORTED_KWH_C": ["EXPORTED C KWH", "exportedc", ENERGY_KILO_WATT_HOUR, None, None],
